...
Item {
    id: delegate
    width: delegate.ListView.view.width; height: delegate.ListView.view.height*.15
    clip: true
    Rectangle {
        id: container
        width: delegate.width; height: delegate.height; border.color: "#8b988b"; radius: delegate.width*.03
        ...
        Text {
            ...
            color: "white"
            font { family: "Sans"; pixelSize: parent.height*.3; bold: true }
            anchors {
