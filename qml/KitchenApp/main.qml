...
Rectangle {
        ...
        AppGrid {
            ...
            Button {
                ...
                MouseArea {
                    anchors.fill: parent
                    // make sure you put the name of your qml as an argument
                    onClicked: {launch("SocialFeed.qml",2);speaker.say("Social Networking")}
                }
            }
            Button {
                id: musicPlayerLaunch
            ...
            Button {
                ...
                MouseArea {
                    anchors.fill: parent
                    // make sure you put the name of your qml as an argument
                    onClicked: {launch("weather.qml",4);speaker.say("Weather Forecast")}
                }
            }
            Button {
                id: kitchenAppLaunch
                ...
                MouseArea {
                    anchors.fill: parent
                    // make sure you put the name of your qml as an argument
                     onClicked: {launch("Kitchen.qml",5);speaker.say("Kitchen")}
                }
            }
            Button {
                id: transitAppLaunch
    ...
    function launch(qmlComp,index)
    {
        ...
        if(appgrid.activeList[index] === 0){
            var component = Qt.createComponent(qmlComp);
            if(component.status === Component.Ready) {
                var app = component.createObject(desktop,{"appIndex": index, "appGrid": appgrid});
